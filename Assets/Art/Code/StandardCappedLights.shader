...
Shader "LD39/Standard (Capped Lights)"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			#pragma fragment myFragForwardAddInternal
			#include "UnityStandardCoreForward.cginc"

			half4 myFragForwardAddInternal(VertexOutputForwardAdd i) : SV_Target
			{
				...
				c.rgb *= 0.5 * saturate(sourceTextureGreyscale / lightGreyscale);
